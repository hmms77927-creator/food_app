...
=======
// import 'package:flutter_application_appnexts/Controllers/imagepicker_controllers.dart';
...
//         onTap: () {
//       // controller.pickImage(); // works now
//       },
//         child: Obx(() => Container(
//           height: 258,
//           width: 342,
...
//             ElevatedButton(
//               onPressed: () {
//                 FirebaseFirestore.instance.collection('add_restaurant').add({
>>>>>>> 2afc647 (Initial commit)
...
=======
//                 }).then((value) {
//                   print('Restaurant added successfully: ${value.id}');
//                 }).catchError((error) {
